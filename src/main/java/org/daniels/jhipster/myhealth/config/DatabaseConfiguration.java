...
@EnableElasticsearchRepositories("org.daniels.jhipster.myhealth.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "org.daniels.jhipster.myhealth.config.HerokuDatabaseConfiguration")
